...
# Form implementation generated from reading ui file 'D:\pyCharm\project\UI\graph3DDialog.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.graph3DWgt = MatplotlibWidget(Dialog)
        self.graph3DWgt.setObjectName("graph3DWgt")
        self.verticalLayout.addWidget(self.graph3DWgt)
        self.actionColorFilling = QtWidgets.QAction(Dialog)
        self.actionColorFilling.setCheckable(True)
        self.actionColorFilling.setEnabled(True)
        icon1 = QtGui.QIcon()
