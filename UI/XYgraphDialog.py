...
"""
Module implementing XYgraphDialog.
"""

from PyQt5.QtCore import pyqtSlot,Qt
from PyQt5.QtWidgets import QDialog

from UI.Ui_XYgraphDialog import Ui_Dialog


class XYgraphDialog(QDialog, Ui_Dialog):
    """
    ...
    def __init__(self, parent=None):
        ...
        @type QWidget
        """
        super(XYgraphDialog, self).__init__(parent)
        self.setupUi(self)
